    ...
    <div class="relative w-full overflow-hidden h-full flex flex-col">
        ...
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full rounded-lg shadow dark:border md:mt-0 sm:max-w-4xl xl:p-0 bg-white border-white z-30 mx-auto">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" @submit.prevent="createContactPost" @keydown.enter.exact.prevent="createContactPost">
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="description" id="description" placeholder="Lorem impsum..." class="text-wrap pb-32 bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-200 dark:border-gray-300 dark:placeholder-gray-400 dark:text-dark dark:focus:ring-blue-500 dark:focus:border-blue-500" required="" v-model="description">
                        </div>
                        <button type="submit" class="w-full text-dark bg-primary-600 focus:outline-none font-medium rounded-lg text-lg px-5 pb-4 text-center dark:bg-primary-600">Send</button>
                    </form>
                </div>
            </div>
    </div>
